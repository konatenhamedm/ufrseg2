...
(b.isPlainObject(c.extraData[C])&&c.extraData[C].hasOwnProperty("name")&&c.extraData[C].hasOwnProperty("value")?G.push(b('<input type="hidden" name="'+c.extraData[C].name+'">').val(c.extraData[C].value).appendTo(q)[0]):G.push(b('<input type="hidden" name="'+C+'">').val(c.extraData[C]).appendTo(q)[0]));c.iframeTarget||J.appendTo("body");F.attachEvent?F.attachEvent("onload",v):F.addEventListener("load",v,!1);setTimeout(h,15);try{q.submit()}catch(I){document.createElement("form").submit.apply(q)}}finally{q.setAttribute("action",
